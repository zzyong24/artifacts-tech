...
### 竖版安全区域速查表（9:16, 1080×1920）

> 详见 `VERTICAL.md`。此处提供快速参考。

| 区域 | Y 范围 | 高度 | 说明 |
|------|--------|------|------|
| 平台标题避让 | 0 ~ 80px | 80px | 留空 |
| **内容主区** | 80 ~ 1340px | 1260px | 核心教学内容 |
| 过渡区 | 1340 ~ 1520px | 180px | 辅助/过渡 |
| **字幕安全区** | 1520 ~ 1760px | 240px | TTS 字幕 |
| 平台互动避让 | 1760 ~ 1920px | 160px | 留空 |

水平：左右各 60px 边距，右侧额外避让 120px（平台互动按钮）。

```css
/* 竖版安全区域模板 */
#deck[data-h="1920"] .slide {
  padding: 80px 60px 580px 60px;
